...
<ul>
    ...
    <li><a href="/news/XiaoRu/index.php/Home/Index/guoji">国际新闻</a></li>
    <li><a href="/news/XiaoRu/index.php/Home/Index/junshi">军事新闻</a></li>
    <li><a href="/news/XiaoRu/index.php/Home/Index/yule">娱乐新闻</a></li>
</ul>
</div>
...
<div id="main1">
    ...
    <ul>
    	<li><a href="#"><img src="/news/XiaoRu/Public/images/05.jpg"  height="178" /></a><p><a href="#">图片新闻</a></p></li>
        <li><a href="#"><img src="/news/XiaoRu/Public/images/01.jpg" /></a><p><a href="#">图片新闻</a></p></li>
...
<div class="news">
	<div class="title"><h3>国内新闻</h3><a href="#">更多&gt;&gt;</a></div>
            <ul class="width">
                <?php if(is_array($arr)): foreach($arr as $key=>$v): ?><li><span><?php echo ($v["addtime"]); ?></span>  <a  href="/news/XiaoRu/index.php/Home/Index/detail?news_id=<?php echo ($v["news_id"]); ?>"><?php echo ($v["news_title"]); ?></a></li><?php endforeach; endif; ?>
