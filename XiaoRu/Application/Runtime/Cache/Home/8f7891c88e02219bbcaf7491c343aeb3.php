    ...
    <div class="main-wrap">
        ...
        <div class="welcome" style="font-size: 16px;color:black;vertical-align: middle;">
            <div style="width: 90%;margin: auto;margin-bottom: 10px">
                ...
                <a href="/news/XiaoRu/index.php/Home/Admin/users_add">添加用户</a>
            ...
            <table border="1">
                ...
                <?php if(is_array($user_list)): foreach($user_list as $k=>$v): ?><tr style="color:#000;" height="60px">
                        <td><?php echo ($k+1); ?></td>
                        <td><?php echo ($v['admin_name']); ?>
                        <?php if($v['poster'] == 0): ?>(管理员)
                            <?php else: ?>(记者)<?php endif; ?>
