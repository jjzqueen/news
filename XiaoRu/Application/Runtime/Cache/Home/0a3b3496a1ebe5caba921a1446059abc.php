    ...
    <div class="main-wrap">
        ...
        <div class="welcome" style="font-size: 16px;color:black;vertical-align: middle;">
            ...
            <div style="width: 90%;margin: auto;text-align: center">
                <form action="/news/XiaoRu/index.php/Home/Admin/edit_pro?id=<?php echo ($data['admin_id']); ?>,admin" method="post">
                    <table style="width: 100%">
                        <tr height="60px">
                            <td width="45%" align="right">用户名:</td>
                            <td align="left">&nbsp;&nbsp;<input type="text" value="<?php echo ($data['admin_name']); ?>"  name="admin_name" style="width: 200px;height: 30px"></td>
                        </tr>
                        <tr height="60px">
                            <td width="45%" align="right">设置密码:</td>
                            <td align="left">&nbsp;&nbsp;<input type="password"  name="admin_pwd" value="<?php echo substr($data['admin_pwd'],0,6);?>" style="width: 200px;height: 30px"></td>
                        </tr>
                        <tr height="60px">
                            <td width="45%" align="right">电话:</td>
                            <td align="left">&nbsp;&nbsp;<input type="text" required name="admin_phone" value="<?php echo ($data['admin_phone']); ?>" style="width: 200px;height: 30px"></td>
                        </tr>
                        <tr height="60px">
                            ...
                            <td align="left">&nbsp;&nbsp;
                                <select name="poster" required style="width: 200px;height: 35px;text-align: center">
                                    ...
                                    <?php if($data['poster'] == 0): ?><option value="0" selected>管理员</option>
                                        <option value="1">记者</option>
                                    <?php else: ?>
                                        <option value="0">管理员</option>
                                        <option value="1" selected>记者</option><?php endif; ?>
                        ...
                        <tr height="60px">
                            <td colspan="2">
                                <input type="submit" value="修 改" style="width: 100px;height: 35px;font-size: 18px">&nbsp;&nbsp;&nbsp;&nbsp;
