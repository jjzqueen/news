...
<div class="news">
    <div class="title"><h3>今日新闻</h3></div>
    <ul style="width: 100%">
        <?php if(is_array($news_more)): foreach($news_more as $key=>$v): ?><li style="width: 88%;text-align: left"><span><?php echo ($v["add_date"]); ?></span>  <a  href="/news/XiaoRu/index.php/Home/Index/detail?news_id=<?php echo ($v["id"]); ?>" style="font-size: 16px;text-align: left;width: 60%"><?php echo ($v["title"]); ?></a></li><?php endforeach; endif; ?>
