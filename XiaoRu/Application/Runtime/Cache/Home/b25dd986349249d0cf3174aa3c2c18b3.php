    ...
    <div class="main-wrap">
        ...
        <div class="welcome" style="font-size: 16px;color:black;vertical-align: middle;">
            ...
            <div style="width: 90%;margin: auto;text-align: center">
                <form action="/news/XiaoRu/index.php/Home/Admin/cates_add" method="post">
                    <table style="width: 100%">
                        <tr height="60px">
                            <td width="45%" align="right">新闻类别名称:</td>
                            <td align="left">&nbsp;&nbsp;<input type="text" required name="cate_name" style="width: 200px;height: 30px"></td>
                        </tr>
                        <tr height="60px">
                            <td colspan="2">
