...
<div id="main1">
    ...
    <ul>
    	<li><a href="#"><img src="/XiaoRu/Public/images/01.jpg"  height="178" /></a><p><a href="#">图片新闻</a></p></li>
        ...
        <li><a href="#"><img src="/XiaoRu/Public/images/06.jpg" /></a><p><a href="#">图片新闻</a></p></li>
    </ul>
</div>
...
<div class="news">
    ...
    <ul>
    <?php if(is_array($news)): foreach($news as $key=>$v): ?><li><span><?php echo ($v["addtime"]); ?></span>  <a  href="/XiaoRu/index.php/Home/Index/detail?news_id=<?php echo ($v["news_id"]); ?>"><?php echo ($v["news_title"]); ?></a></li><?php endforeach; endif; ?>
